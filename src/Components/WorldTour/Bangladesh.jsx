...
const Bangladesh = ({bangladesh}) => {
    const {imageUrl,touristSpotName,countryName,averageCost,seasonality,travelTime ,
        totalVisitorsPerYear,location,description} = bangladesh;
