...
const List = ({list}) => {
    const {imageUrl,touristSpotName,countryName,averageCost,seasonality,travelTime ,
        totalVisitorsPerYear,location,description} = list;
    console.log(list)
    return (
        <div>
        <div  data-aos="fade-left"  data-aos-duration="1200" className="w-[400px] h-[520px] shadow-md rounded p-2">
