...
const Guids = () => {
    return (
        <div>
          ...
          >
            <SwiperSlide>
            <div data-aos="flip-left"  data-aos-duration="1200"  className='flex flex-col justify-center w-[300px] h-[250px] items-center gap-1 shadow-lg  bg-gray-400'>
            <div className='  '>
            ...
            <div className='p-2'>
               ...
               <h1 className='text-xl font-bold text-gray-500'>Guider Name</h1>
                <h3 className='text-xl  pb-3 font-bold text-orange-800'>ATLAN</h3>
            </div>
          </div>
      
            </SwiperSlide>
            <SwiperSlide>
            <div data-aos="flip-down"  data-aos-duration="1200"  className='flex flex-col justify-center w-[300px] h-[250px] items-center gap-1 shadow-lg bg-gray-400'>
            <div className='  '>
            ...
            <SwiperSlide>
            <div data-aos="flip-up"  data-aos-duration="1200"  className='flex flex-col justify-center w-[300px] h-[250px] items-center gap-1 shadow-lg  bg-gray-400'>
            <div className=' '>
            ...
            <SwiperSlide>
            <div data-aos="flip-right"  data-aos-duration="1200"  className='flex flex-col justify-center w-[300px] h-[250px]  items-center gap-1 shadow-lg  bg-gray-400'>
            <div className=' '>
