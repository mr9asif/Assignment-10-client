...
const Offer = () => {
    return (
       ...
       <svg className='w-[20px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#63E6BE" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
       <p className='text-gray-100 font-semibold text-xl '><span className='font-bold text-orange-600'>Savings</span>: 30% off helps couples save on their dream honeymoon..</p>
       </div>
       <div className='flex items-center gap-1'>
       <svg className='w-[20px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#63E6BE" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
       <p className='text-gray-100 font-semibold text-xl '><span className='font-bold text-orange-600'>Luxury</span>: Discount allows for a more luxurious experience.</p>
       </div>
       <div className='flex items-center gap-1'>
       <svg className='w-[20px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#63E6BE" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
       <p className='text-gray-100 font-semibold text-xl '><span className='font-bold text-orange-600'>Memorable</span>:Adds celebration, making honeymoon more memorable.</p>
       </div>
