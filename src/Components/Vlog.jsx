...
const Vlog = () => {
    return (
       ...
       <div className='grid grid-cols-3 justify-between items-center w-full gap-16 border'>
       <div data-aos="fade-left"  data-aos-duration="1200"  className=' '>
       <div className='w-[430px] h-[440px] shadow-lg '>
          ...
          <div className='flex flex-col gap-2 p-5 '>
             ...
             <h3 className='text-[17px] text-gray-700 font-semibold'>Exlpore Maldip with TRAVELER, You can see How we Travel, you can also see this ...</h3>
              <p className='text-gray-400 font-bold pl-80'>01/10/2023</p>
          </div>
       </div>
